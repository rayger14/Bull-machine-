#!/usr/bin/env python3
"""
Generate Trades CSV from BTC v3.0 Backtest

Creates trades CSV in the format expected by what_if_max_hold.py
"""
...
def main():
    ...
    # Run backtest
    print("Running BTC v3.0 backtest (Q3 2024)...")
    ...
    output_path = Path('reports/optuna_results/BTC_v3_q3_2024_trades.csv')
