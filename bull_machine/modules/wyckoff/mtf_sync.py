...
def mtf_alignment(daily_df: pd.DataFrame, h4_df: pd.DataFrame,
                  liquidity_score: float) -> Tuple[bool, Dict]:
    """
    ...
    logging.info(f"MTF Alignment: aligned={aligned}, score={alignment_score:.2f}, "
...
def get_mtf_context(df_1h: pd.DataFrame, df_4h: pd.DataFrame,
