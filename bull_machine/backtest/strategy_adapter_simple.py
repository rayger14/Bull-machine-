...
def generate_simple_signal(symbol: str, tf: str, df_window: pd.DataFrame,
                          balance: float = 10000) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        sync_result = decide_mtf_entry(
            htf_bias, mtf_bias, ltf_bias.bias,
            nested_ok, eq_magnet, policy
        )
