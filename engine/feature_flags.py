...
ENABLE_WYCKOFF = True         # Wyckoff structural events (springs, UTAD, phases) - PHASE 4 ENABLED
ENABLE_SMC = True             # Smart Money Concepts (BOS, liquidity sweeps, supply/demand) - PHASE 4 ENABLED
ENABLE_TEMPORAL = True        # Temporal Fusion (Fibonacci time clusters, PTI confluence) - PHASE 4 ENABLED
