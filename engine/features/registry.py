...
class FeatureRegistry:
    ...
    def _register_tier2(self):
        ...
        tier2_features = [
            ...
            # Wyckoff Events (Phase A: Selling/Buying Climax)
            FeatureSpec("wyckoff_sc", "bool", 2, False,
                       [], None, None,
                       "Selling Climax detected (capitulation at lows)"),
            FeatureSpec("wyckoff_sc_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Selling Climax detection confidence"),
            FeatureSpec("wyckoff_bc", "bool", 2, False,
                       [], None, None,
                       "Buying Climax detected (euphoria at highs)"),
            FeatureSpec("wyckoff_bc_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Buying Climax detection confidence"),
            FeatureSpec("wyckoff_ar", "bool", 2, False,
                       [], None, None,
                       "Automatic Rally detected (relief bounce after SC)"),
            FeatureSpec("wyckoff_ar_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Automatic Rally detection confidence"),
            FeatureSpec("wyckoff_as", "bool", 2, False,
                       [], None, None,
                       "Automatic Reaction detected (relief drop after BC)"),
            FeatureSpec("wyckoff_as_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Automatic Reaction detection confidence"),
            FeatureSpec("wyckoff_st", "bool", 2, False,
                       [], None, None,
                       "Secondary Test detected (retest of SC lows)"),
            FeatureSpec("wyckoff_st_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Secondary Test detection confidence"),

            # Wyckoff Events (Phase B: Building Cause/Effect)
            FeatureSpec("wyckoff_sos", "bool", 2, False,
                       [], None, None,
                       "Sign of Strength detected (decisive move up)"),
            FeatureSpec("wyckoff_sos_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Sign of Strength detection confidence"),
            FeatureSpec("wyckoff_sow", "bool", 2, False,
                       [], None, None,
                       "Sign of Weakness detected (decisive move down)"),
            FeatureSpec("wyckoff_sow_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Sign of Weakness detection confidence"),

            # Wyckoff Events (Phase C: Testing)
            FeatureSpec("wyckoff_spring_a", "bool", 2, False,
                       [], None, None,
                       "Spring Type A detected (deep fake breakdown)"),
            FeatureSpec("wyckoff_spring_a_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Spring Type A detection confidence"),
            FeatureSpec("wyckoff_spring_b", "bool", 2, False,
                       [], None, None,
                       "Spring Type B detected (shallow spring)"),
            FeatureSpec("wyckoff_spring_b_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Spring Type B detection confidence"),
            FeatureSpec("wyckoff_ut", "bool", 2, False,
                       [], None, None,
                       "Upthrust detected (fake breakout above range)"),
            FeatureSpec("wyckoff_ut_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Upthrust detection confidence"),
            FeatureSpec("wyckoff_utad", "bool", 2, False,
                       [], None, None,
                       "Upthrust After Distribution detected (final trap)"),
            FeatureSpec("wyckoff_utad_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "UTAD detection confidence"),

            # Wyckoff Events (Phase D: Last Point)
            FeatureSpec("wyckoff_lps", "bool", 2, False,
                       [], None, None,
                       "Last Point of Support detected (final test before markup)"),
            FeatureSpec("wyckoff_lps_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "LPS detection confidence"),
            FeatureSpec("wyckoff_lpsy", "bool", 2, False,
                       [], None, None,
                       "Last Point of Supply detected (final rally before markdown)"),
            FeatureSpec("wyckoff_lpsy_confidence", "float64", 2, False,
                       [], 0.0, 1.0,
                       "LPSY detection confidence"),

            # Wyckoff Phase Classification
            FeatureSpec("wyckoff_phase_abc", "category", 2, False,
                       [], None, None,
                       "Wyckoff phase: A/B/C/D/E/neutral"),
            FeatureSpec("wyckoff_sequence_position", "int8", 2, False,
                       [], 0, 10,
                       "Position in Wyckoff sequence (1-10)"),

            # Wyckoff-PTI Integration
            FeatureSpec("wyckoff_pti_confluence", "bool", 2, False,
                       [], None, None,
                       "High PTI + Wyckoff trap event confluence"),
            FeatureSpec("wyckoff_pti_score", "float64", 2, False,
                       [], 0.0, 1.0,
                       "Composite Wyckoff-PTI trap score"),

            # SMC (Smart Money Concepts) Features
            FeatureSpec("smc_demand_zone", "bool", 2, False,
                       [], None, None,
                       "SMC demand zone (institutional buying area)"),
            FeatureSpec("smc_supply_zone", "bool", 2, False,
                       [], None, None,
                       "SMC supply zone (institutional selling area)"),
            FeatureSpec("smc_liquidity_sweep", "bool", 2, False,
                       [], None, None,
                       "SMC liquidity sweep detected (stop hunt)"),
            FeatureSpec("smc_choch", "bool", 2, False,
                       [], None, None,
                       "SMC Change of Character (trend reversal)"),

            # HOB (Higher Order Book) Features
            FeatureSpec("hob_demand_zone", "bool", 2, False,
                       [], None, None,
                       "HOB demand zone (large bid walls)"),
            FeatureSpec("hob_supply_zone", "bool", 2, False,
                       [], None, None,
                       "HOB supply zone (large ask walls)"),
            FeatureSpec("hob_imbalance", "float64", 2, False,
                       [], -1.0, 1.0,
                       "HOB order book imbalance (bid/ask ratio)"),

            # Temporal Features
            FeatureSpec("fib_time_cluster", "bool", 2, False,
                       [], None, None,
                       "Fibonacci time cluster (geometric reversal point)"),
            FeatureSpec("temporal_confluence", "bool", 2, False,
                       [], None, None,
                       "Multi-timeframe temporal confluence"),
            FeatureSpec("temporal_resistance_cluster", "bool", 2, False,
                       [], None, None,
                       "Temporal resistance cluster (price + time)"),
            FeatureSpec("temporal_support_cluster", "bool", 2, False,
                       [], None, None,
                       "Temporal support cluster (price + time)"),
        ]
