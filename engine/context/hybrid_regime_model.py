...
class HybridRegimeModel:
    """
    Hybrid Regime Model combining crisis rules with ML.

    Production-ready implementation:
    - Crisis: Rule-based (high recall)
    ...
    3. Else → use ML model for normal regime classification (Layer 2)
    4. Optional: Apply hysteresis for stability (Layer 3 - handled by RegimeService)
    ...
    def __init__(
        self,
        ml_model_path: str = 'models/logistic_regime_v3.pkl',
        ...
        Args:
            ml_model_path: Path to LogisticRegimeModel v3
        ...
        logger.info("✓ Layer 1: Crisis detector initialized (rule-based)")

        # Layer 2: ML classifier for normal regimes
        ...
        logger.info("\nConflict Resolution: Crisis rules override ML classifier")
        logger.info("=" * 80)
