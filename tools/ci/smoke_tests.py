...
class SmokeTestSuite:
    ...
    def test_fusion_scoring(self) -> bool:
        ...
        try:
            ...
            test_cases = [
                # High quality trade
                {
                    'wyckoff': 0.80, 'liquidity': 0.75, 'structure': 0.65,
                    'momentum': 0.60, 'volume': 0.70, 'context': 0.50, 'mtf': 0.65
                },
                # Marginal trade
                {
                    'wyckoff': 0.38, 'liquidity': 0.33, 'structure': 0.45,
                    'momentum': 0.40, 'volume': 0.50, 'context': 0.40, 'mtf': 0.55
                },
                # Poor quality trade
                {
                    'wyckoff': 0.30, 'liquidity': 0.25, 'structure': 0.35,
                    'momentum': 0.30, 'volume': 0.30, 'context': 0.20, 'mtf': 0.40
                }
            ]
            ...
            for i, scores in enumerate(test_cases):
                result = engine.fuse_scores(
                    scores,
                    quality_floors=self.config['quality_floors']
                )
    ...
    def test_determinism(self) -> bool:
        ...
        try:
            ...
            test_scores = {
                'wyckoff': 0.70, 'liquidity': 0.65, 'structure': 0.60,
                'momentum': 0.55, 'volume': 0.60, 'context': 0.45, 'mtf': 0.70
            }
