...
def test_strategy_adapter_signals():
    ...
    if valid_signals:
        ...
        print("❌ No valid signals generated by strategy adapter")
        return False
...
def test_backtest_engine_integration():
    ...
    try:
        ...
        if os.path.exists(trades_file):
            ...
            if entry_trades > 0:
                print("✅ Backtest generated entry trades!")
                return True

        if results['metrics']['trades'] > 0:
            print("✅ Backtest generated exit trades!")
            return True
        else:
...
def test_signal_validation():
    ...
    print(f"Valid signal test: {'✅ PASSED' if is_valid else '❌ FAILED'}")
    ...
    print(f"Invalid signal test: {'✅ PASSED' if is_invalid else '❌ FAILED'}")

    return is_valid and is_invalid

def main():
    """Run all signal flow tests."""
    print("🧪 SIGNAL FLOW INTEGRATION TESTS")
    print("=" * 80)
