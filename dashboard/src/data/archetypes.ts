...
export const ARCHETYPES: Record<string, ArchetypeInfo> = {
  trap_within_trend: {
    ...
    pf: '4.51',
    dir: 'long',
    trades: '60 OOS / 119 full',
    desc: 'False breakdown in strong uptrend. Price briefly breaks below support, trapping shorts, then reverses sharply. Best archetype by PF.',
    explanation:
    ...
    gates: [
      ...
      'liquidity_score < liquidity_threshold (default 0.30)',
  ...
  wick_trap: {
    ...
    pf: '1.68',
    dir: 'long',
    trades: '232 OOS / 563 full',
    desc: 'Bullish wick rejection reversal. Large lower wick = buyers aggressively rejecting lower prices. Dominant trade generator (~44%).',
    explanation:
