...
**Total Execution Time**: 56.8s
**Timestamp**: 2025-12-17 15:52:43
...
| G    | Liquidity Sweep      |      97 |  100.0% |     0.44 |     3.87 |      1.07 |          1.78x |      100.0% | 100% LONG / 0% SHORT |
...
**Total execution time**: 56.8s
**Average per archetype**: 3.55s

**Slowest archetypes**:
  - S1 (Liquidity Vacuum): 18.48s
  - L (Retest Cluster): 5.08s
  - C (Wick Trap): 4.18s
  - S8 (Volume Fade Chop): 3.34s
  - M (Confluence Breakout): 3.23s
