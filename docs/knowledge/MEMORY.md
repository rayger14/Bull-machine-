...
- [H3 parent permission](h3_parent_permission_results_2026_09_10.md): pure fixed-event sidecar added at `c0929a4`, reviewed causal-prefix/batch defects fixed at `2bd6b70`; 46 focused / 265 full research tests pass (existing LibreSSL warning). Same-stream June10–20 population: 38 earliest native LC structural passes and76 frozen minute sweep events, all4parent variants,456annotations. LC permissions4H_N3=1,others0; minute4H_N3=16,4H_N5=19,1D_N3=8,1D_N5=0; no unknowns under evaluator contract. Full720h vs rebuilt456h records/IDs equal, fresh copied-input results equal, no mutation. Hourly savedATR formula unverified; minute uses separately frozen same-stream TA-Lib ATR14 June1 cold-start reference, not native parity. Counts are not profits and may reflect absent-parent coverage; no winning variant selected, native selection untouched. Next: coverage/prehistory and consumed-field evidence, then separately registered displacement-aware economic comparisons—not turn H3 into a universal gate.
