...
- [Layered entry study in progress](layered_entry_study_2026_09_11.md): user approved broader dates and minute evidence inside larger structure. Fixed March/May/July, first qualifying candidate perhalfmonth pertrack, up to12cases. SameBinance1m source supplies1m/5m/15m/1h/4h/daily layers and1m outcome scoring; 30dayseeded native17archetype signal replay. Separate rulecards and prefix-checked pivot/touch/sweep witnesses implemented;416researchtests pass. Fresh assessor perCASE prevents later packets revealing earlier outcomes. No expandedstudy outcomes/assessments yet. Initial preparation guard correctly blocked optionalurllib3IPv6probe; constructor-only reproduction plus existing scopedIPv6-off pattern verified, guardsintact. Three isolated monthly replays restarted with immutable permonthcaches. Private drivers/results local, notGitHub; commit8cb080c has reusablehelper/tests/protocol. September8minute source notfound in targetedlocalinventory; no fabrications/venue splice. Resume existing processes rather than duplicate.
