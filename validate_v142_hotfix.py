...
def test_wider_stops_markup_phases():
    ...
    test_cases = [
        ...
        ("Phase C (Consolidation)", [54000] * 20, [49000] * 20, [51500] * 20, 1.5)  # Mid close in range
    ]
...
def test_regime_filter_enhancement():
    ...
    test_cases = [
        ...
        ("High-vol A phase", 0.7, {'phase': 'A'}, [1000] * 19 + [2500], True),  # Should pass due to volume
        ("High Wyckoff A phase", 0.9, {'phase': 'A'}, [1000] * 20, True),  # Should pass due to score
